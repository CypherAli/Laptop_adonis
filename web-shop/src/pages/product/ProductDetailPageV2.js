...
const ProductDetailPageV2 = () => {
  ...
  useEffect(() => {
    ...
    if (matchedVariant) {
      ...
      console.warn('⚠️ No variant found for:', {
  ...
  const handleAddToCart = () => {
    ...
    if (currentStock > 0) {
      ...
      toast.success(
        `✅ Đã thêm ${quantity}x ${product.name} (${selectedGender}, Size ${selectedSize}, ${selectedColor}) vào giỏ hàng!`
      )
    } else {
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      ...
                      boxShadow:
                        selectedImage === null
                          ? '0 4px 12px rgba(108, 77, 230, 0.3)'
            ...
            <div>
              ...
              >
                ...
                <div style={{ marginBottom: '25px' }}>
                  ...
                  >
                    <h4
                      style={{ fontSize: '14px', color: '#374151', fontWeight: '600', margin: 0 }}
                    >
                ...
                <div style={{ marginBottom: '20px' }}>
                  ...
                  <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                    {Object.keys(soleTypePricing).map((soleType) => (
                      ...
                      >
                        {soleType}{' '}
                        {soleTypePricing[soleType] > 0 &&
                          `(+${(soleTypePricing[soleType] / 1000).toFixed(0)}k)`}
                      </button>
                    ))}
                  </div>
                </div>
                    ...
                    {Object.keys(boxPricing).map((boxType) => (
                      <button
                        ...
                        style={{
                          padding: '8px 14px',
                          border:
                            selectedBoxType === boxType ? '2px solid #6366f1' : '2px solid #e5e7eb',
                          borderRadius: '8px',
                      ...
                      >
                        {boxType}{' '}
                        {boxPricing[boxType] > 0 &&
                          `(+${(boxPricing[boxType] / 1000).toFixed(0)}k)`}
                      </button>
                    ))}
                  </div>
                </div>
              ...
              >
                ...
                <div style={{ display: 'grid', gap: '12px' }}>
                  ...
                  <div style={{ display: 'flex', gap: '10px' }}>
                    ...
                    <span>
                      {availableColors.length > 0
                        ? `${Math.min(...product.variants.map((v) => parseInt(v.specifications?.size || v.size || 0)))} - ${Math.max(...product.variants.map((v) => parseInt(v.specifications?.size || v.size || 0)))}`
                        : 'Đang cập nhật'}
                    </span>
                  </div>
                  <div style={{ display: 'flex', gap: '10px' }}>
                  ...
                  <div style={{ display: 'flex', gap: '10px' }}>
                    ...
                    <span>
                      {selectedVariant?.specifications?.material ||
                  ...
                  <div style={{ display: 'flex', gap: '10px' }}>
                    ...
                    <span>
                      {selectedVariant?.specifications?.display ||
                  ...
                  <div style={{ display: 'flex', gap: '10px' }}>
                    ...
                    <span>
                      {selectedVariant?.specifications?.graphics ||
                  ...
                  <div style={{ display: 'flex', gap: '10px' }}>
                    ...
                    <span>
                      {selectedVariant?.specifications?.operatingSystem ||
                  ...
                  <div style={{ display: 'flex', gap: '10px' }}>
                    ...
                    <span>
                      {selectedVariant?.specifications?.weight ||
