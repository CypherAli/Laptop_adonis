                    ...
                    <td className="action-buttons">
                      ...
                      {user.role === 'partner' && !user.isApproved && (
                        <button
                          ...
                          onClick={() => handleApprovePartner(user._id)}
                        >
                          Phê duyệt
                        </button>
                      )}
                      {user.role === 'partner' && user.isApproved && (
                        <button
                          ...
                          onClick={() => handleRejectPartner(user._id)}
                        >
                          Thu hồi
                        </button>
                      )}
              ...
              <tbody>
                {products.map((product) => (
                  <tr key={product._id}>
                    ...
                    <td>
                      <span
                        className={`badge ${product.isFeatured ? 'badge-warning' : 'badge-secondary'}`}
                      >
        ...
        <div className="data-section">
          <div className="section-header">
            ...
            <select
              ...
              onChange={(e) => setReviewApprovedFilter(e.target.value)}
              className="filter-select"
            >
